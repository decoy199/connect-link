...
SECRET_KEY = get_env_variable('SECRET_KEY', 'dev-secret-key-change-me-in-production')
...
DEFAULT_FROM_EMAIL = get_env_variable('DEFAULT_FROM_EMAIL', 'noreply@handraise.com')
